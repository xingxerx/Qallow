...
static void qallow_print_phase_help(void) {
    ...
    printf("  --eps=E                   Elasticity epsilon (default: 1e-4)\n");
    printf("  --log=FILE                Override CSV path (default data/logs/phase12.csv)\n");
    printf("  --audit-tag=TAG           Stamp audit tag into telemetry rows\n\n");
    printf("Phase 13 options:\n");
    printf("  --nodes=N                 Harmonic pockets (default: 8)\n");
    printf("  --ticks=N                 Number of ticks (default: 400)\n");
    printf("  --k=F                     Coupling constant (default: 0.001)\n");
    printf("  --log=FILE                Override CSV path (default data/logs/phase13.csv)\n");
    printf("  --audit-tag=TAG           Stamp audit tag into telemetry rows\n\n");
    ...
    printf("  qallow phase 12 --ticks=100 --eps=0.0001 --audit-tag=demo\n");
    printf("  qallow phase 12 --audit-tag=demo --log=/tmp/run12.csv\n");
    printf("  qallow phase 13 --nodes=16 --ticks=500 --k=0.002 --audit-tag=bench\n");
