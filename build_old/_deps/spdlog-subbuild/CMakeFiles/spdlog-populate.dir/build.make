...
CMAKE_SOURCE_DIR = /root/Qallow/build/_deps/spdlog-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /root/Qallow/build/_deps/spdlog-subbuild
...
CMakeFiles/spdlog-populate-complete: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'spdlog-populate'"
	/usr/sbin/cmake -E make_directory /root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles
	/usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles/spdlog-populate-complete
	/usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-done
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-build: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'spdlog-populate'"
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E echo_append
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-build
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-configure: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'spdlog-populate'"
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E echo_append
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-configure
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-download: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (git clone) for 'spdlog-populate'"
	cd /root/Qallow/build/_deps && /usr/sbin/cmake -DCMAKE_MESSAGE_LOG_LEVEL=VERBOSE -P /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/tmp/spdlog-populate-gitclone.cmake
	cd /root/Qallow/build/_deps && /usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-download
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-install: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'spdlog-populate'"
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E echo_append
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-install

spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'spdlog-populate'"
	/usr/sbin/cmake -Dcfgdir= -P /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/tmp/spdlog-populate-mkdirs.cmake
	/usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-mkdir
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-patch: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'spdlog-populate'"
	/usr/sbin/cmake -E echo_append
	/usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-patch
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-test: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'spdlog-populate'"
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E echo_append
	cd /root/Qallow/build/_deps/spdlog-build && /usr/sbin/cmake -E touch /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-test
...
spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-update: spdlog-populate-prefix/src/spdlog-populate-stamp/spdlog-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "Performing update step for 'spdlog-populate'"
	cd /root/Qallow/build/_deps/spdlog-src && /usr/sbin/cmake -Dcan_fetch=YES -DCMAKE_MESSAGE_LOG_LEVEL=VERBOSE -P /root/Qallow/build/_deps/spdlog-subbuild/spdlog-populate-prefix/tmp/spdlog-populate-gitupdate.cmake
...
CMakeFiles/spdlog-populate.dir/depend:
	cd /root/Qallow/build/_deps/spdlog-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/Qallow/build/_deps/spdlog-subbuild /root/Qallow/build/_deps/spdlog-subbuild /root/Qallow/build/_deps/spdlog-subbuild /root/Qallow/build/_deps/spdlog-subbuild /root/Qallow/build/_deps/spdlog-subbuild/CMakeFiles/spdlog-populate.dir/DependInfo.cmake "--color=$(COLOR)"
