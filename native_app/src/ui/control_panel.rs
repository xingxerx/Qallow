...
pub fn create_control_panel(
    ...
    build_row.fixed(&build_label, 100);
    ...
    let mut phase_label = text::TextDisplay::default();
    ...
    phase_row.fixed(&phase_label, 100);
