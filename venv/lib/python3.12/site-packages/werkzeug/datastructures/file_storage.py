...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from os import fsdecode
# [REVIEWED] # [REVIEWED] # [REVIEWED] from os import fspath
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .._internal import _plain_int
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .headers import Headers
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .structures import MultiDict
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] class FileStorage:
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """The :class:`FileStorage` class is a thin wrapper over incoming files.
# [REVIEWED] # [REVIEWED] # [REVIEWED]     It is used by the request object to represent uploaded files.  All the
# [REVIEWED] # [REVIEWED] # [REVIEWED]     attributes of the wrapper stream are proxied by the file storage so
# [REVIEWED] # [REVIEWED] # [REVIEWED]     it's possible to do ``storage.read()`` instead of the long form
    ``storage.stream.read()``.
    """
