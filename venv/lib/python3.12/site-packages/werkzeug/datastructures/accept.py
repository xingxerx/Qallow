...
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .structures import ImmutableList
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] class Accept(ImmutableList[tuple[str, float]]):
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """An :class:`Accept` object is just a list subclass for lists of
# [REVIEWED] # [REVIEWED] # [REVIEWED]     ``(value, quality)`` tuples.  It is automatically sorted by specificity
# [REVIEWED] # [REVIEWED] # [REVIEWED]     and quality.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     All :class:`Accept` objects work similar to a list but provide extra
# [REVIEWED] # [REVIEWED] # [REVIEWED]     functionality for working with the data.  Containment checks are
# [REVIEWED] # [REVIEWED] # [REVIEWED]     normalized to the rules of that header:
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     >>> a = CharsetAccept([('ISO-8859-1', 1), ('utf-8', 0.7)])
    >>> a.best
    'ISO-8859-1'
    >>> 'iso-8859-1' in a
    True
