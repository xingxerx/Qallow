...
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .exceptions import ClientDisconnected
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .exceptions import RequestEntityTooLarge
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .sansio import utils as _sansio_utils
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .sansio.utils import host_is_trusted  # noqa: F401 # Imported as part of API
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] if t.TYPE_CHECKING:
# [REVIEWED] # [REVIEWED] # [REVIEWED]     from _typeshed.wsgi import WSGIApplication
# [REVIEWED] # [REVIEWED] # [REVIEWED]     from _typeshed.wsgi import WSGIEnvironment
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] def responder(f: t.Callable[..., WSGIApplication]) -> WSGIApplication:
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """Marks a function as responder.  Decorate a function with it and it
# [REVIEWED] # [REVIEWED] # [REVIEWED]     will automatically call the return value as WSGI application.
