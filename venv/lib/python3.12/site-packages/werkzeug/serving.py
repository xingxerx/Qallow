# [REVIEWED] # [REVIEWED] # [REVIEWED] """A WSGI and HTTP server for use **during development only**. This
# [REVIEWED] # [REVIEWED] # [REVIEWED] server is convenient to use, but is not designed to be particularly
# [REVIEWED] # [REVIEWED] # [REVIEWED] stable, secure, or efficient. Use a dedicate WSGI server and HTTP
# [REVIEWED] # [REVIEWED] # [REVIEWED] server when deploying to production.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] It provides features like interactive debugging and code reloading. Use
# [REVIEWED] # [REVIEWED] # [REVIEWED] ``run_simple`` to start the server. Put this in a ``run.py`` script:
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] .. code-block:: python
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     from myapp import create_app
# [REVIEWED] # [REVIEWED] # [REVIEWED]     from werkzeug import run_simple
# [REVIEWED] # [REVIEWED] # [REVIEWED] """
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
