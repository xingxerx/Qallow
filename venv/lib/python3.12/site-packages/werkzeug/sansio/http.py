...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from ..http import parse_date
# [REVIEWED] # [REVIEWED] # [REVIEWED] from ..http import parse_etags
# [REVIEWED] # [REVIEWED] # [REVIEWED] from ..http import parse_if_range_header
# [REVIEWED] # [REVIEWED] # [REVIEWED] from ..http import unquote_etag
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] _etag_re = re.compile(r'([Ww]/)?(?:"(.*?)"|(.*?))(?:\s*,\s*|$)')
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] def is_resource_modified(
# [REVIEWED] # [REVIEWED] # [REVIEWED]     http_range: str | None = None,
# [REVIEWED] # [REVIEWED] # [REVIEWED]     http_if_range: str | None = None,
# [REVIEWED] # [REVIEWED] # [REVIEWED]     http_if_modified_since: str | None = None,
