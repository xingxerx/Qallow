...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from pathlib import PurePath
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] from ._internal import _log
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] # The various system prefixes where imports are found. Base values are
# [REVIEWED] # [REVIEWED] # [REVIEWED] # different when running in a virtualenv. All reloaders will ignore the
# [REVIEWED] # [REVIEWED] # [REVIEWED] # base paths (usually the system installation). The stat reloader won't
# [REVIEWED] # [REVIEWED] # [REVIEWED] # scan the virtualenv paths, it will only include modules that are
# [REVIEWED] # [REVIEWED] # [REVIEWED] # already imported.
# [REVIEWED] # [REVIEWED] # [REVIEWED] _ignore_always = tuple({sys.base_prefix, sys.base_exec_prefix})
