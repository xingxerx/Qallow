...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from urllib.parse import urlencode
...
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] def _codec_error_url_quote(e: UnicodeError) -> tuple[str, int]:
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """Used in :func:`uri_to_iri` after unquoting to re-quote any
# [REVIEWED] # [REVIEWED] # [REVIEWED]     invalid bytes.
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """
# [REVIEWED] # [REVIEWED] # [REVIEWED]     # the docs state that UnicodeError does have these attributes,
