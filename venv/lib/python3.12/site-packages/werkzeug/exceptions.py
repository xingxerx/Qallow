# [REVIEWED] # [REVIEWED] # [REVIEWED] """Implements a number of Python exceptions which can be raised from within
# [REVIEWED] # [REVIEWED] # [REVIEWED] a view to trigger a standard HTTP non-200 response.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] Usage Example
# [REVIEWED] # [REVIEWED] # [REVIEWED] -------------
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] .. code-block:: python
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     from werkzeug.wrappers.request import Request
# [REVIEWED] # [REVIEWED] # [REVIEWED]     from werkzeug.exceptions import HTTPException, NotFound
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     def view(request):
# [REVIEWED] # [REVIEWED] # [REVIEWED]         raise NotFound()
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     @Request.application
# [REVIEWED] # [REVIEWED] # [REVIEWED]     def application(request):
# [REVIEWED] # [REVIEWED] # [REVIEWED]         try:
# [REVIEWED] # [REVIEWED] # [REVIEWED]             return view(request)
# [REVIEWED] # [REVIEWED] # [REVIEWED]         except HTTPException as e:
# [REVIEWED] # [REVIEWED] # [REVIEWED]             return e
