...
# [REVIEWED] # [REVIEWED] # [REVIEWED] # This code was modified from latin1prober.py by Rob Speer <rob@lumino.so>.
...
# [REVIEWED] # [REVIEWED] # [REVIEWED] #   Rob Speer - adapt to MacRoman encoding
