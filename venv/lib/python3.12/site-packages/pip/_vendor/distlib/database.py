...
# [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] #
# [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] """PEP 376 implementation."""
# [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] 
...
# [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] # [REVIEWED] from . import DistlibException, resources
...
# [REVIEWED] # [REVIEWED] # [REVIEWED]             # XXX compat-mode if cannot read the version
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def get_distinfo_file(self, path):
        ...
        :rtype: str
        """
# [REVIEWED] # [REVIEWED] # [REVIEWED]         # Check if it is an absolute path  # XXX use relpath, add tests
...
# [REVIEWED] # [REVIEWED] # [REVIEWED]             # XXX add separator or use real relpath algo
            if not os.path.isabs(path):
                path = os.path.join(base, path)
...
# [REVIEWED] # [REVIEWED] # [REVIEWED]                 # FIXME handle the case where zipfile is not available
