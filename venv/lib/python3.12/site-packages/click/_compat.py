...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from weakref import WeakKeyDictionary
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] CYGWIN = sys.platform.startswith("cygwin")
# [REVIEWED] # [REVIEWED] # [REVIEWED] WIN = sys.platform.startswith("win")
# [REVIEWED] # [REVIEWED] # [REVIEWED] auto_wrap_for_ansi: t.Callable[[t.TextIO], t.TextIO] | None = None
# [REVIEWED] # [REVIEWED] # [REVIEWED] _ansi_re = re.compile(r"\033\[[;?0-9]*[a-zA-Z]")
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] def _make_text_stream(
# [REVIEWED] # [REVIEWED] # [REVIEWED]     stream: t.BinaryIO,
    encoding: str | None,
    errors: str | None,
