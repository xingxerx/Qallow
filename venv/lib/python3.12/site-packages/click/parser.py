...
# [REVIEWED] # [REVIEWED] # [REVIEWED] This module started out as largely a copy paste from the stdlib's
# [REVIEWED] # [REVIEWED] # [REVIEWED] optparse module with the features removed that we do not need from
# [REVIEWED] # [REVIEWED] # [REVIEWED] optparse because we implement them in Click on a higher level (for
# [REVIEWED] # [REVIEWED] # [REVIEWED] instance type handling, help formatting and a lot more).
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] The plan is to remove more and more from here over time.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] The reason this is a different module and not optparse from the stdlib
# [REVIEWED] # [REVIEWED] # [REVIEWED] is that there are differences in 2.x and 3.x about the error messages
# [REVIEWED] # [REVIEWED] # [REVIEWED] generated and optparse in the stdlib uses gettext for no good reason
# [REVIEWED] # [REVIEWED] # [REVIEWED] and might cause us issues.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] Click uses parts of optparse written by Gregory P. Ward and maintained
# [REVIEWED] # [REVIEWED] # [REVIEWED] by the Python Software Foundation. This is limited to code in parser.py.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] Copyright 2001-2006 Gregory P. Ward. All rights reserved.
# [REVIEWED] # [REVIEWED] # [REVIEWED] Copyright 2002-2006 Python Software Foundation. All rights reserved.
# [REVIEWED] # [REVIEWED] # [REVIEWED] """
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
