...
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] class BadData(Exception):
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """Raised if bad data of any sort was encountered. This is the base
# [REVIEWED] # [REVIEWED] # [REVIEWED]     for all exceptions that ItsDangerous defines.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     .. versionadded:: 0.15
# [REVIEWED] # [REVIEWED] # [REVIEWED]     """
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     def __init__(self, message: str):
# [REVIEWED] # [REVIEWED] # [REVIEWED]         super().__init__(message)
# [REVIEWED] # [REVIEWED] # [REVIEWED]         self.message = message
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     def __str__(self) -> str:
# [REVIEWED] # [REVIEWED] # [REVIEWED]         return self.message
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
