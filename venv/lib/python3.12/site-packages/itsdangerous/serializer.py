...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from .signer import _make_keys_list
...
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED]     # This should be either be str or bytes. To avoid having to specify the
# [REVIEWED] # [REVIEWED] # [REVIEWED]     # bound type, it falls back to a union if structural matching fails.
# [REVIEWED] # [REVIEWED] # [REVIEWED]     _TSerialized = te.TypeVar(
# [REVIEWED] # [REVIEWED] # [REVIEWED]         "_TSerialized", bound=t.Union[str, bytes], default=t.Union[str, bytes]
# [REVIEWED] # [REVIEWED] # [REVIEWED]     )
else:
