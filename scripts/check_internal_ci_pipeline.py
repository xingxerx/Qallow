...
# [REVIEWED] # [REVIEWED] # [REVIEWED] """Validate and optionally restore the canonical internal CI workflow.
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] This helper keeps `.github/workflows/internal-ci.yml` in sync with the
# [REVIEWED] # [REVIEWED] # [REVIEWED] reference pipeline we maintain in-repo.  It is meant to be run in CI as
# [REVIEWED] # [REVIEWED] # [REVIEWED] well as locally before pushing workflow changes.
# [REVIEWED] # [REVIEWED] # [REVIEWED] """
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
...
# [REVIEWED] # [REVIEWED] # [REVIEWED] from typing import Sequence, List, Tuple
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] WORKFLOW_PATH = Path(".github/workflows/internal-ci.yml")
# [REVIEWED] # [REVIEWED] # [REVIEWED] 
# [REVIEWED] # [REVIEWED] # [REVIEWED] CANONICAL_PIPELINE_B64 = (
